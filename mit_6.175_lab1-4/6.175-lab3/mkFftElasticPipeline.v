...
//
// On Sat Nov 12 19:02:00 PST 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkFftElasticPipeline(CLK,
			    RST_N,
  ...
  wire CAN_FIRE_RL_stage3, WILL_FIRE_RL_stage1, WILL_FIRE_RL_stage2;
  ...
  // submodule fifo1
  FIFO2 #(.width(32'd1024), .guarded(1'd1)) fifo1(.RST(RST_N),
						  .CLK(CLK),
						  .D_IN(fifo1$D_IN),
						  .ENQ(fifo1$ENQ),
						  .DEQ(fifo1$DEQ),
  ...
  // submodule fifo2
  FIFO2 #(.width(32'd1024), .guarded(1'd1)) fifo2(.RST(RST_N),
						  .CLK(CLK),
						  .D_IN(fifo2$D_IN),
						  .ENQ(fifo2$ENQ),
						  .DEQ(fifo2$DEQ),
  ...
  // rule RL_stage1
  assign WILL_FIRE_RL_stage1 = fifo1$FULL_N && inFifo$EMPTY_N ;

  // rule RL_stage2
  assign WILL_FIRE_RL_stage2 =
	     fifo2$FULL_N && fifo1$EMPTY_N && !WILL_FIRE_RL_stage1 ;

  // rule RL_stage3
  assign CAN_FIRE_RL_stage3 = outFifo$FULL_N && fifo2$EMPTY_N ;
  ...
  assign bfly_1_0$bfly4_x = fifo1$D_OUT[63:0] ;

  // submodule bfly_1_1
  assign bfly_1_1$bfly4_t = 64'h0307030602050204 ;
  assign bfly_1_1$bfly4_x = fifo1$D_OUT[127:64] ;

  // submodule bfly_1_10
  assign bfly_1_10$bfly4_t = 64'h152B152A14291428 ;
  assign bfly_1_10$bfly4_x = fifo1$D_OUT[703:640] ;

  // submodule bfly_1_11
  assign bfly_1_11$bfly4_t = 64'h172F172E162D162C ;
  assign bfly_1_11$bfly4_x = fifo1$D_OUT[767:704] ;

  // submodule bfly_1_12
  assign bfly_1_12$bfly4_t = 64'h1933193218311830 ;
  assign bfly_1_12$bfly4_x = fifo1$D_OUT[831:768] ;

  // submodule bfly_1_13
  assign bfly_1_13$bfly4_t = 64'h1B371B361A351A34 ;
  assign bfly_1_13$bfly4_x = fifo1$D_OUT[895:832] ;

  // submodule bfly_1_14
  assign bfly_1_14$bfly4_t = 64'h1D3B1D3A1C391C38 ;
  assign bfly_1_14$bfly4_x = fifo1$D_OUT[959:896] ;

  // submodule bfly_1_15
  assign bfly_1_15$bfly4_t = 64'h1F3F1F3E1E3D1E3C ;
  assign bfly_1_15$bfly4_x = fifo1$D_OUT[1023:960] ;

  // submodule bfly_1_2
  assign bfly_1_2$bfly4_t = 64'h050B050A04090408 ;
  assign bfly_1_2$bfly4_x = fifo1$D_OUT[191:128] ;

  // submodule bfly_1_3
  assign bfly_1_3$bfly4_t = 64'h070F070E060D060C ;
  assign bfly_1_3$bfly4_x = fifo1$D_OUT[255:192] ;

  // submodule bfly_1_4
  assign bfly_1_4$bfly4_t = 64'h0913091208110810 ;
  assign bfly_1_4$bfly4_x = fifo1$D_OUT[319:256] ;

  // submodule bfly_1_5
  assign bfly_1_5$bfly4_t = 64'h0B170B160A150A14 ;
  assign bfly_1_5$bfly4_x = fifo1$D_OUT[383:320] ;

  // submodule bfly_1_6
  assign bfly_1_6$bfly4_t = 64'h0D1B0D1A0C190C18 ;
  assign bfly_1_6$bfly4_x = fifo1$D_OUT[447:384] ;

  // submodule bfly_1_7
  assign bfly_1_7$bfly4_t = 64'h0F1F0F1E0E1D0E1C ;
  assign bfly_1_7$bfly4_x = fifo1$D_OUT[511:448] ;

  // submodule bfly_1_8
  assign bfly_1_8$bfly4_t = 64'h1123112210211020 ;
  assign bfly_1_8$bfly4_x = fifo1$D_OUT[575:512] ;

  // submodule bfly_1_9
  assign bfly_1_9$bfly4_t = 64'h1327132612251224 ;
  assign bfly_1_9$bfly4_x = fifo1$D_OUT[639:576] ;

  // submodule bfly_2_0
  assign bfly_2_0$bfly4_t = 64'h0103010200010000 ;
  assign bfly_2_0$bfly4_x = fifo2$D_OUT[63:0] ;

  // submodule bfly_2_1
  assign bfly_2_1$bfly4_t = 64'h0307030602050204 ;
  assign bfly_2_1$bfly4_x = fifo2$D_OUT[127:64] ;

  // submodule bfly_2_10
  assign bfly_2_10$bfly4_t = 64'h152B152A14291428 ;
  assign bfly_2_10$bfly4_x = fifo2$D_OUT[703:640] ;

  // submodule bfly_2_11
  assign bfly_2_11$bfly4_t = 64'h172F172E162D162C ;
  assign bfly_2_11$bfly4_x = fifo2$D_OUT[767:704] ;

  // submodule bfly_2_12
  assign bfly_2_12$bfly4_t = 64'h1933193218311830 ;
  assign bfly_2_12$bfly4_x = fifo2$D_OUT[831:768] ;

  // submodule bfly_2_13
  assign bfly_2_13$bfly4_t = 64'h1B371B361A351A34 ;
  assign bfly_2_13$bfly4_x = fifo2$D_OUT[895:832] ;

  // submodule bfly_2_14
  assign bfly_2_14$bfly4_t = 64'h1D3B1D3A1C391C38 ;
  assign bfly_2_14$bfly4_x = fifo2$D_OUT[959:896] ;

  // submodule bfly_2_15
  assign bfly_2_15$bfly4_t = 64'h1F3F1F3E1E3D1E3C ;
  assign bfly_2_15$bfly4_x = fifo2$D_OUT[1023:960] ;

  // submodule bfly_2_2
  assign bfly_2_2$bfly4_t = 64'h050B050A04090408 ;
  assign bfly_2_2$bfly4_x = fifo2$D_OUT[191:128] ;

  // submodule bfly_2_3
  assign bfly_2_3$bfly4_t = 64'h070F070E060D060C ;
  assign bfly_2_3$bfly4_x = fifo2$D_OUT[255:192] ;

  // submodule bfly_2_4
  assign bfly_2_4$bfly4_t = 64'h0913091208110810 ;
  assign bfly_2_4$bfly4_x = fifo2$D_OUT[319:256] ;

  // submodule bfly_2_5
  assign bfly_2_5$bfly4_t = 64'h0B170B160A150A14 ;
  assign bfly_2_5$bfly4_x = fifo2$D_OUT[383:320] ;

  // submodule bfly_2_6
  assign bfly_2_6$bfly4_t = 64'h0D1B0D1A0C190C18 ;
  assign bfly_2_6$bfly4_x = fifo2$D_OUT[447:384] ;

  // submodule bfly_2_7
  assign bfly_2_7$bfly4_t = 64'h0F1F0F1E0E1D0E1C ;
  assign bfly_2_7$bfly4_x = fifo2$D_OUT[511:448] ;

  // submodule bfly_2_8
  assign bfly_2_8$bfly4_t = 64'h1123112210211020 ;
  assign bfly_2_8$bfly4_x = fifo2$D_OUT[575:512] ;

  // submodule bfly_2_9
  assign bfly_2_9$bfly4_t = 64'h1327132612251224 ;
  assign bfly_2_9$bfly4_x = fifo2$D_OUT[639:576] ;
  ...
  assign fifo1$D_IN =
	     { bfly_0_15$bfly4[63:48],
	       ...
	       bfly_0_0$bfly4[15:0] } ;
  assign fifo1$ENQ = WILL_FIRE_RL_stage1 ;
  assign fifo1$DEQ = WILL_FIRE_RL_stage2 ;
  ...
  assign fifo2$D_IN =
	     { bfly_1_15$bfly4[63:48],
	       ...
	       bfly_1_0$bfly4[15:0] } ;
  assign fifo2$ENQ = WILL_FIRE_RL_stage2 ;
  assign fifo2$DEQ = CAN_FIRE_RL_stage3 && !WILL_FIRE_RL_stage2 ;
  assign fifo2$CLR = 1'b0 ;

  // submodule inFifo
  assign inFifo$D_IN = enq_in ;
  assign inFifo$ENQ = EN_enq ;
  assign inFifo$DEQ = fifo1$FULL_N && inFifo$EMPTY_N ;
  ...
  assign outFifo$D_IN =
	     { bfly_2_15$bfly4[63:48],
	       ...
	       bfly_2_0$bfly4[15:0] } ;
  assign outFifo$ENQ = CAN_FIRE_RL_stage3 && !WILL_FIRE_RL_stage2 ;
  assign outFifo$DEQ = EN_deq ;
  assign outFifo$CLR = 1'b0 ;
endmodule  // mkFftElasticPipeline
