...
public:
    ...
    MemServerRequestProxy(int id, PortalTransportFunctions *transport, void *param, MemServerRequestCb *cbarg = &MemServerRequestProxyReq, int bufsize = MemServerRequest_reqinfo, PortalPoller *poller = 0) :
        Portal(id, DEFAULT_TILE, bufsize, NULL, NULL, transport, param, this, poller), cb(cbarg) {};
    MemServerRequestProxy(int id, PortalPoller *poller) :
        Portal(id, DEFAULT_TILE, MemServerRequest_reqinfo, NULL, NULL, NULL, NULL, this, poller), cb(&MemServerRequestProxyReq) {};
...
public:
    ...
    MemServerRequestWrapper(int id, PortalTransportFunctions *transport, void *param, PORTAL_INDFUNC cba = MemServerRequest_handleMessage, int bufsize = MemServerRequest_reqinfo, PortalPoller *poller=0):
           Portal(id, DEFAULT_TILE, bufsize, cba, (void *)&MemServerRequest_cbTable, transport, param, this, poller) {
    };
    ...
    MemServerRequestWrapper(int id, PortalTransportFunctions *transport, void *param, PortalPoller *poller):
           Portal(id, DEFAULT_TILE, MemServerRequest_reqinfo, MemServerRequest_handleMessage, (void *)&MemServerRequest_cbTable, transport, param, this, poller) {
    };
