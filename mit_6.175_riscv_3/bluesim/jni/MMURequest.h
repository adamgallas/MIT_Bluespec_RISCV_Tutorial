...
public:
    ...
    MMURequestProxy(int id, PortalTransportFunctions *transport, void *param, MMURequestCb *cbarg = &MMURequestProxyReq, int bufsize = MMURequest_reqinfo, PortalPoller *poller = 0) :
        Portal(id, DEFAULT_TILE, bufsize, NULL, NULL, transport, param, this, poller), cb(cbarg) {};
    MMURequestProxy(int id, PortalPoller *poller) :
        Portal(id, DEFAULT_TILE, MMURequest_reqinfo, NULL, NULL, NULL, NULL, this, poller), cb(&MMURequestProxyReq) {};
...
public:
    ...
    MMURequestWrapper(int id, PortalTransportFunctions *transport, void *param, PORTAL_INDFUNC cba = MMURequest_handleMessage, int bufsize = MMURequest_reqinfo, PortalPoller *poller=0):
           Portal(id, DEFAULT_TILE, bufsize, cba, (void *)&MMURequest_cbTable, transport, param, this, poller) {
    };
    ...
    MMURequestWrapper(int id, PortalTransportFunctions *transport, void *param, PortalPoller *poller):
           Portal(id, DEFAULT_TILE, MMURequest_reqinfo, MMURequest_handleMessage, (void *)&MMURequest_cbTable, transport, param, this, poller) {
    };
