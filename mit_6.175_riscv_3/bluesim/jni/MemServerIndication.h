...
public:
    ...
    MemServerIndicationProxy(int id, PortalTransportFunctions *transport, void *param, MemServerIndicationCb *cbarg = &MemServerIndicationProxyReq, int bufsize = MemServerIndication_reqinfo, PortalPoller *poller = 0) :
        Portal(id, DEFAULT_TILE, bufsize, NULL, NULL, transport, param, this, poller), cb(cbarg) {};
    MemServerIndicationProxy(int id, PortalPoller *poller) :
        Portal(id, DEFAULT_TILE, MemServerIndication_reqinfo, NULL, NULL, NULL, NULL, this, poller), cb(&MemServerIndicationProxyReq) {};
...
public:
    ...
    MemServerIndicationWrapper(int id, PortalTransportFunctions *transport, void *param, PORTAL_INDFUNC cba = MemServerIndication_handleMessage, int bufsize = MemServerIndication_reqinfo, PortalPoller *poller=0):
           Portal(id, DEFAULT_TILE, bufsize, cba, (void *)&MemServerIndication_cbTable, transport, param, this, poller) {
    };
    ...
    MemServerIndicationWrapper(int id, PortalTransportFunctions *transport, void *param, PortalPoller *poller):
           Portal(id, DEFAULT_TILE, MemServerIndication_reqinfo, MemServerIndication_handleMessage, (void *)&MemServerIndication_cbTable, transport, param, this, poller) {
    };
