...
public:
    ...
    MMUIndicationProxy(int id, PortalTransportFunctions *transport, void *param, MMUIndicationCb *cbarg = &MMUIndicationProxyReq, int bufsize = MMUIndication_reqinfo, PortalPoller *poller = 0) :
        Portal(id, DEFAULT_TILE, bufsize, NULL, NULL, transport, param, this, poller), cb(cbarg) {};
    MMUIndicationProxy(int id, PortalPoller *poller) :
        Portal(id, DEFAULT_TILE, MMUIndication_reqinfo, NULL, NULL, NULL, NULL, this, poller), cb(&MMUIndicationProxyReq) {};
...
public:
    ...
    MMUIndicationWrapper(int id, PortalTransportFunctions *transport, void *param, PORTAL_INDFUNC cba = MMUIndication_handleMessage, int bufsize = MMUIndication_reqinfo, PortalPoller *poller=0):
           Portal(id, DEFAULT_TILE, bufsize, cba, (void *)&MMUIndication_cbTable, transport, param, this, poller) {
    };
    ...
    MMUIndicationWrapper(int id, PortalTransportFunctions *transport, void *param, PortalPoller *poller):
           Portal(id, DEFAULT_TILE, MMUIndication_reqinfo, MMUIndication_handleMessage, (void *)&MMUIndication_cbTable, transport, param, this, poller) {
    };
